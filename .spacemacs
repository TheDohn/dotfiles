...
;;       ))
  ...
  (cond
   ...
   ((string= sytem-name "DB_personal-Macbook-Pro.local")
          (setq org-directory "")
          (setq org-agenda-files nil)
    )
   )
